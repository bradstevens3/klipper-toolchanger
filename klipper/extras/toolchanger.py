...
class Toolchanger:
    ...
    def cmd_SET_TOOL_TEMPERATURE(self, gcmd):
        ...
        if wait_cmd:
            ...
            heater = tool.extruder.get_heater()     # Get the heater object
            cur_temp = heater.get_temp()            # Get current temperature (float)
